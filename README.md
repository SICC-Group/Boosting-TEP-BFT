# TEP-BFT
This is the official code for the paper entitled "Boosting Consensus Efficiency: Parallelism and Blockchain-Enhanced Remote Attestation in Trusted Execution Environments".

A Supplementary Materials PDF file is avaiable [here](https://github.com/SICC-Group/Boosting-TEP-BFT/blob/main/Supplementary%20Materials.pdf), including some proofs and additional experiments.

The Chinese version of README.md can be found at [README_zh.md](https://github.com/SICC-Group/Boosting-TEP-BFT/blob/main/README_zh.md)
